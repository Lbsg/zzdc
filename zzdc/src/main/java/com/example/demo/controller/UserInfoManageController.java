 ...
 */
@RestController
@RequestMapping("/UserOrBusinessBaseInfoManage")
public class UserInfoManageController extends BaseController{
    ...
    public void editUserOrBusiness(String name, String phone, String address, int sex, String password, String type, HttpServletRequest req, HttpServletResponse resp){
        int editResult = infoService.editUserOrBusinessInfo(name, phone, address, sex, password, type);
        ResultPages rs = new ResultPages();
